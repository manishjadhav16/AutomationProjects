...
public class WebUtils {
	...
	public static String getPageTitle(){
		String str = null;
		try {
			str = new String(driver.getTitle().getBytes("iso-8859-1"), "utf-8");
...
//			driver.getTitle().getBytes("charset=UTF-8");
...
//		decodeString("Latest Hindi News | Breaking & Daily News in Hindi | Live World, Entertainment & Sports News in Hindi | ???? at India.com Hindi");
		decodeString("पीएम मोदी ने कहा, ब्रेन ड्रेन नहीं, ब्रेन गेन का मौका आया है");
	}
