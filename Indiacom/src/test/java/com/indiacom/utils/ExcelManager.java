...
public class ExcelManager {
    ...
    public void setInputFile( String inputFile ) {
        ExcelManager.inputFile = inputFile;
    }
    ...
    public static List<HashMap<String, String>> getTestDataFromExcel( InputStream is, String sheetName ) {
        ...
        /*try {
        	BufferedWriter bw = new BufferedWriter(new FileWriter("D:\\Git\\CCAutomation\\src\\test\\resources\\Data\\dump.txt"));
...
//            is = getClass().getResourceAsStream("/Data/Page-Meta-tags.xls");
            workbook = Workbook.getWorkbook( new File("D:\\selenium-automation-project\\Indiacom\\src\\test\\resources\\Data\\urllist.xls"), ws );
